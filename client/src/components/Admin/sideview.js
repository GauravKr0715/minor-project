...
function Sideview() {
    ...
    return (
        ...
        <div className="container">{
         ...
         <div className="nav">
            <div>
          <Link to="/ALandingpage">  <img src={logo} alt="" className="img"/></Link>
            <p>Admin</p>
            </div>
            
            <div className="Opt1">
            <ul style={{listStyleType:"none"}}>
               <Link to="/Subjects"  style={{textDecoration:"none",color:"beige"}}> <li><div className="icon"> <i class="fas fa-book"></i></div>&nbsp;  Subjects</li></Link>
               ...
               <Link to="/SectionC" style={{textDecoration:"none",color:"beige"}}>  <li ><div className="icon"><i className="fas fa-table"></i></div> &nbsp;Section Creation</li></Link>
